(function () {
  ...
  var translations = {
    en: {
      ...
      lblSimulations: 'Number of simulations',
      simRunning: 'Running simulation ({n} replications)…',
      simDone: 'Done in {time}.',
      ...
      simHistY: 'Proportion',
      simMeansHistX: 'Mean total score',
      simMeansHistY: 'Count',
    ...
    es: {
      ...
      lblSimulations: 'Número de simulaciones',
      simRunning: 'Ejecutando simulación ({n} réplicas)…',
      simDone: 'Listo en {time}.',
      simError: 'Error en la simulación.',
      ...
      simHistY: 'Proporción',
      simMeansHistX: 'Media de puntuación total',
      simMeansHistY: 'Frecuencia',
